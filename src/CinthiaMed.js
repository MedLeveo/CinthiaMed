...
const CinthiaMed = ({ user, onLogout }) => {
  ...
  const streamText = async (fullText, messageIndex, sources) => {
    ...
    // Adicionar fontes após completar o streaming
          ...
          {menuItems.map((item, index) => (
            <button
              ...
              style={{
                ...
                borderRadius: '12px',
                color: activeMenuAction === item.action ? '#a78bfa' : '#94a3b8',
                cursor: 'pointer',
        ...
        {!sidebarCollapsed && (
          <div style={{
            ...
            <div>
              ...
              {conversations.filter(c => !c.isFavorite).slice(0, 5).length > 0 ? (
                conversations
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '10px 16px',
                    backgroundColor: 'transparent',
                    border: `1px solid ${isCurrentConversationFavorite() ? '#fbbf24' : '#334155'}`,
                    borderRadius: '10px',
                    color: isCurrentConversationFavorite() ? '#fbbf24' : '#94a3b8',
                    cursor: 'pointer',
                    fontSize: '14px',
                    fontWeight: '500',
                    transition: 'all 0.2s',
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = 'transparent';
                    e.currentTarget.style.borderColor = isCurrentConversationFavorite() ? '#fbbf24' : '#334155';
                    e.currentTarget.style.color = isCurrentConversationFavorite() ? '#fbbf24' : '#94a3b8';
                  }}
                >
                  <svg
                    width="18"
              ...
              {messages.map((msg, index) => (
                ...
                >
                  <div style={{
                    ...
                    maxWidth: '75%',
                    minWidth: msg.content.length < 50 ? 'auto' : '300px',
                  }}>
                    {/* Avatar */}
                    <div style={{
                      width: '48px',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  Grave o áudio da consulta online e a IA identifica automaticamente os pontos importantes para gerar um prontuário médico completo
                </p>
              </div>
              ...
              {!selectedScore ? (
                ...
                <>
                  ...
                  <div style={{
                    ...
                    {['PECARN TCE', 'Ânion Gap', 'Idade Gestacional', 'IMC e ASC', 'QTc', 'Osmolalidade',
                      'CIWA-Ar', 'Correção de Cálcio', 'Correção de Sódio', 'Framingham', 'Hestia',
                      'Sgarbossa', 'Wells TEP', 'Wells TVP', 'Déficit Água Livre', 'Depuração Creatinina',
                      'MDRD', 'RASS', 'NIHSS', 'Glasgow', '2HELPS2B', 'ABCD²', 'AIR', 'CHA₂DS₂-VASc',
                      'CURB-65', 'Alvarado', 'EDACS', 'Centor', 'Dissecção Aórtica', 'Genebra',
                      'Risco Genebra TEV', 'Síncope Canadense', 'TIMI', 'Rockall', 'Glasgow-Blatchford',
                      'FeverPAIN', 'HEART', 'MACOCHA', 'NEWS 2', 'PSI/PORT', 'qSOFA', 'SOFA',
                      'Índice de Choque', 'PESI', 'Mortalidade Endarterectomia', 'NEXUS Crânio',
                      'NEXUS Coluna', 'NEXUS Tórax', 'Peso Corporal Ideal', 'PAM', 'Regra Canadense TC',
                      'Ottawa HSA', 'PERC', 'TFG CKD-EPI', '4AT', '6MWT'].map((score, index) => (
                      <div
                        key={index}
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <p>Formulário em desenvolvimento para {selectedScore}</p>
                      <p style={{ fontSize: '14px', marginTop: '8px' }}>
                        Em breve você poderá calcular este escore diretamente
                      </p>
                    </div>
                  </div>

                  {/* Collapsible Sections */}
                  {['Critérios de uso', 'Observações relevantes', 'Referências'].map((section) => (
                    <div
                      key={section}
                      style={{
                        backgroundColor: '#1a1f2e',
                    ...
                    >
                      ...
                      <p style={{
                        ...
                        Informações sobre {section.toLowerCase()} para {selectedScore}
                      </p>
                    </div>
                  ))}
                </div>
